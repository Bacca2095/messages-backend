...
export class initial1675629356455 implements MigrationInterface {
    name = 'initial1675629356455'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`constraint_entity\` (\`id\` int NOT NULL AUTO_INCREMENT, \`field\` varchar(255) NOT NULL, \`value\` varchar(255) NOT NULL, \`condition\` enum ('between', 'equal', 'less', 'more', 'contain') NOT NULL, \`campaignId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`constraint_entity\` ADD CONSTRAINT \`FK_e854668d3dde3b370fb5a4dcf31\` FOREIGN KEY (\`campaignId\`) REFERENCES \`campaign\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`constraint_entity\` DROP FOREIGN KEY \`FK_e854668d3dde3b370fb5a4dcf31\``);
        ...
        await queryRunner.query(`DROP TABLE \`constraint_entity\``);
    }
