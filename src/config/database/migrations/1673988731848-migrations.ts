...
export class migrations1673988731848 implements MigrationInterface {
  name = 'migrations1673988731848';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `client` ADD `emailVerified` bit NOT NULL DEFAULT 0',
    );
    await queryRunner.query(
