...
export class migrations1673989034535 implements MigrationInterface {
  name = 'migrations1673989034535';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `client` ADD `emailVerified` tinyint NOT NULL DEFAULT 0',
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE `client` DROP COLUMN `emailVerified`');
    await queryRunner.query(
      "ALTER TABLE `client` ADD `emailVerified` bit NOT NULL DEFAULT 'b'0''",
    );
    await queryRunner.query(
